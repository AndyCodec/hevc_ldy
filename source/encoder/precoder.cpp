...
int Precoder::encode_lookahead(const x265_picture* pic_in)
{
...
void Precoder::fetchStats(x265_stats *stats, size_t statsSizeBytes)
{
...
void Precoder::configure(x265_param *p)
{
    this->m_param = p;
...
char* Precoder::statsString(EncStats& stat, char* buffer)
{
    printf("statsString \n");
    double fps = (double)m_param->fpsNum / m_param->fpsDenom;
...
bool Precoder::computeSPSRPSIndex()
{
...
void Precoder::getStreamHeaders(NALList& list, Entropy& sbacCoder, Bitstream& bs)
{
...
void Precoder::freeAnalysis(x265_analysis_data* analysis)
{
