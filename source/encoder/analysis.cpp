...
//
//        //若当前size为8x8，且sps中最小的TU size为4x4，则处理8x8TU下的4个4x4，partion为SIZE_NxN
//        if (cuGeom.log2CUSize == 3 && m_slice->m_sps->quadtreeTULog2MinSize < 3)
//        {
//            md.pred[PRED_INTRA_NxN].cu.initSubCU(parentCTU, cuGeom, qp);
//            checkIntra(md.pred[PRED_INTRA_NxN], cuGeom, SIZE_NxN); //partion为SIZE_NxN，estIntraPredQT中会循环4次调用codeIntraLumaQT
