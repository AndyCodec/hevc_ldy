...
void Lowres::getData() {
    ...
    s += sprintf(s, "\tipCostRatio=%.4f",           ipCostRatio);

    s += sprintf(s, "\tcostEst[0][0]=%lld",         costEst[0][0]);
    s += sprintf(s, "\tcostEstAq[0][0]=%lld",       costEstAq[0][0]);
    s += sprintf(s, "\trowSatds[0][0][0]=%ld",      rowSatds[0][0][0]);
    s += sprintf(s, "\tintraMbs[0]=%d",             intraMbs[0]);
    s += sprintf(s, "\tintraCost[0]=%d",            intraCost[0]);
    s += sprintf(s, "\tintraMode[0]=%d",            intraMode[0]);
    s += sprintf(s, "\tsatdCost=%lld",              satdCost);
    s += sprintf(s, "\tlowresCosts[0][0][0]=%d",    lowresCosts[0][0][0]);
    s += sprintf(s, "\tlowresMvCosts[0][0][0]=%d",  lowresMvCosts[0][0][0]);
    s += sprintf(s, "\tlowresMvs[0][0]=(%d, %d)",   lowresMvs[0][0]->x, lowresMvs[0][0]->y);
    ...
    s += sprintf(s, "\tplannedType[0]=%d",          plannedType[0]);
    s += sprintf(s, "\tplannedSatd[0]=%lld",        plannedSatd[0]);
    ...
    s += sprintf(s, "\twp_sum[2]=%lld",             wp_sum[2]);
    s += sprintf(s, "\tframeVariance=%lld\n",       frameVariance);
